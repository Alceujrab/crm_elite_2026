  ...
  conversations: [
    {
      ...
      messages: [
        { id: "m1", author: "contact", type: "message", text: "Oi, Alana. Conseguiu revisar a proposta do plano enterprise?", time: "14:02" },
        { id: "m2", author: "agent", type: "message", text: "Revisei sim. Ajustei a faixa de usuarios e inclui a migracao assistida sem custo.", time: "14:05" },
        { id: "m3", author: "agent", type: "internal", text: "Nota interna: lead validou budget. Priorizar fechamento hoje com aprovacao financeira.", time: "14:06" },
        { id: "m4", author: "contact", type: "message", text: "Perfeito. Se voce enviar a versao final, eu levo para assinatura ainda hoje.", time: "14:08" }
      ],
      notes: [
        { id: "note-01", text: "Lead chegou por indicacao e exige go-live em 21 dias.", createdAt: "16/03/2026 14:06", author: "Alana Costa", crmContactId: "contact-01", crmDealId: "deal-01", crmTaskId: "task-01" }
      ],
      detailGroups: [
        { title: "Contato", meta: "Atualizado ha 4 min", items: [{ label: "Celular", value: "+55 11 99888-7766", crmContactId: "contact-01" }, { label: "E-mail", value: "paula@heliosgroup.com", crmContactId: "contact-01" }, { label: "Tags", value: "Enterprise • Decisor • Alta prioridade" }] },
        { title: "Negociacoes", meta: "2 abertas", items: [{ label: "Plano Enterprise", value: "R$ 48.000 / ano", crmDealId: "deal-01" }, { label: "Upgrade de integracoes", value: "R$ 8.400 / setup", crmDealId: "deal-09" }] },
        { title: "Tarefas", meta: "Hoje", items: [{ label: "Validar proposta Enterprise", value: "Hoje, 16:30", crmTaskId: "task-01" }, { label: "Enviar contrato Enterprise", value: "Hoje, 17:10", crmTaskId: "task-05" }] },
        { title: "Notas", meta: "Equipe", items: [{ label: "Alana Costa • 16/03/2026 14:06", value: "Lead chegou por indicacao e exige go-live em 21 dias.", noteId: "note-01", crmContactId: "contact-01", crmDealId: "deal-01", crmTaskId: "task-01" }] }
      ]
    },
    {
      id: "2",
      ...
      crmTaskIds: ["task-06"],
      messages: [
        { id: "rm1", author: "contact", type: "message", text: "Ricardo, revisei a clausula de onboarding e parece tudo certo.", time: "13:21" },
        { id: "rm2", author: "agent", type: "message", text: "Perfeito. Vou ajustar apenas o cronograma da implantacao e reenviar o contrato.", time: "13:26" }
      ],
      notes: [
        { id: "note-02", text: "Stakeholder principal pediu vigencia trimestral na proposta.", createdAt: "16/03/2026 13:26", author: "Ricardo Mota", crmContactId: "contact-05", crmDealId: "deal-10", crmTaskId: "task-06" }
      ],
      detailGroups: [
        { title: "Contato", meta: "Atualizado ha 28 min", items: [{ label: "Celular", value: "+55 21 99777-1188", crmContactId: "contact-05" }, { label: "E-mail", value: "ricardo@atlasops.com", crmContactId: "contact-05" }, { label: "Tags", value: "B2B • Revisao juridica" }] },
        { title: "Negociacoes", meta: "1 aberta", items: [{ label: "Plano Growth", value: "R$ 19.000 / ano", crmDealId: "deal-10" }] },
        { title: "Tarefas", meta: "Hoje", items: [{ label: "Enviar contrato revisado", value: "Hoje, 15:40", crmTaskId: "task-06" }] },
        { title: "Notas", meta: "Equipe", items: [{ label: "Ricardo Mota • 16/03/2026 13:26", value: "Stakeholder principal pediu vigencia trimestral na proposta.", noteId: "note-02", crmContactId: "contact-05", crmDealId: "deal-10", crmTaskId: "task-06" }] }
      ]
    }
  ],
...
interface CrmLaneCardMock {
  ...
  lossReason: string;
  movementHistory: CrmMovementMock[];
  activityHistory: CrmActivityMock[];
}

interface CrmLaneMock {
  id: string;
  title: string;
  value: string;
  probability: number;
  count: number;
  cards: CrmLaneCardMock[];
}

interface CrmTaskMock {
  id: string;
  title: string;
  contact: string;
  due: string;
...
interface CrmSummaryMock {
  label: string;
  value: string;
  helper: string;
}

interface CrmDataMock {
  summary: CrmSummaryMock[];
  lanes: CrmLaneMock[];
  tasks: CrmTaskMock[];
  contacts: CrmContactMock[];
  campaigns: CrmCampaignMock[];
  goals: CrmGoalMock[];
}

export const crmData: CrmDataMock = {
  summary: [
